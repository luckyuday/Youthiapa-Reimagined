  ...
  return (
    <footer className="w-full pt-[4rem] px-4 sm:px-6 md:px-8 lg:px-16 xl:px-24 pb-4 sm:pb-6 flex flex-col gap-5">
      <h1
        ...
        text-center font-bold font-[dosis]
      "
      >
        Socials
      </h1>
      <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 md:gap-8">
        <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 group hover:bg-[var(--dark-green)] duration-100 p-2 sm:p-3 rounded-xl flex items-center justify-center">
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="rgba(43,6,30,1)"
              className="group-hover:fill-[var(--seasalt)] w-full h-full"
            >
        ...
        >
          <a
            href="https://x.com/youthiapamachaao"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
      ...
      <div className="w-full border-b border-[var(--dark-green)] pb-2">
        {" "}
        <p className="text-center text-sm sm:text-base font-light">
          {" "}
          &copy; Youthiapa @2025 All rights reserved.
        </p>
      </div>
    </footer>
  );
